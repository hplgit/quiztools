...
class QuizMaker:
    ...
    def get_all_quizes(self):
        """Return list of all quizes belonging to user"""
        raise NotImplementedError
    ...
    def delete_all_quizes(self):
        """Deletes all quizes belonging to user"""
        raise NotImplementedError
...
class KahootQuizMaker(QuizMaker):
    """
    Uses the Kahoot service. Register a user at getkahoot.com. Access 
    your quizes manually at create.kahoot.it to edit or play them.
    """
    ...
    def delete_all_quizes(self):
        ...
        print "This will delete ALL your quizes, are you sure? (Y/n)" 
        if raw_input("...") != "Y":
            print "Aborting"
            return

        quizes = self.get_all_quizes()
        for q in quizes:
...
if __name__ == "__main__":
    ...
    # Deleting all quizes on users Kahoot page
    # qm.delete_all_quizes()
